<div class="kartu-anggota" id="kta-{{ $id ?? '' }}">
  ...
  <div class="kartu-anggota__body">
    <div class="kartu-anggota__side">
      {{-- <img src="{{ $foto ?? '' }}"> --}}
      <div class="kartu-anggota__side-image" style="--url: url('{{ $foto ?? '' }}')"></div>
    </div>
    <div class="kartu-anggota__main">
      <table>
        ...
        <tr>
          ...
          <td colspan="4">{{ $tempat_lahir ?? '' }}, {{ \Carbon\Carbon::parse($tanggal_lahir ?? '01-01-2001')->format('d-m-Y') }}</td>
        </tr>
        <tr>
          <td>Alamat</td>
          <td>:</td>
