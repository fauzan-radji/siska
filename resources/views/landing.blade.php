...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="/img/black.png" media="(prefers-color-scheme:light)">
  <link rel="icon" type="image/x-icon" href="/img/white.png" media="(prefers-color-scheme:dark)">
...
<body class="mt-5">
  <header>
    <nav class="navbar navbar-expand-lg fixed-top py-1 shadow-lg" id="navbar" style="background-color: #48403A;">
      <div class="container-fluid">
        <a class="navbar-brand  lh-1 ms-5" href="#" style="color:white">
          <img class="d-inline-block align-text-bottom object-fit-contain" src="/img/logo tunas.png" style="width:120px; object-fit: contain;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item ms-3">
              <a class="nav-link active fs-3 ms-3" href="#navbar" aria-current="page" style="color:white">Beranda</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fs-3 ms-3" href="#about" style="color:white">Tentang</a>
            </li>
            <li class="nav-item">
              <a class="nav-link fs-3 ms-3" href="#gambar" style="color:white">Foto</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active fs-3 ms-3" href="#sosmed" style="color:white">Kontak</a>
            </li>
          </ul>
          <a class="btn btn-outline-light btn-sm fs-4 py-0" href="/login">Login</a>
          &emsp;
          <a class="btn btn-light btn-sm fs-4 py-0 me-5" href="/register/peserta_didik">Daftar</a>
        </div>
      </div>
    </nav>
  </header>
  <main>
    ...
    <div style="height: 50px" id="gambar"></div>
    <div class="container">
